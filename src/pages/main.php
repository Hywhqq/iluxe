...
<body>
  ...
  <section class="hits">
    <div class="container">
      <h1 class="section__title">Свежие новости!</h1>
    ...
    <div class="container">
      ...
      <div class="about__wrapper">
        <div class="about__info">
          <span>Высокие технологии — наиболее новые и прогрессивные технологии современности. Хай-тек — стиль в дизайне и архитектуре, зародившийся в 1980-е годы. Характеризуется преобладанием техники, металла, пластика.</span>
          <br>
          <br>
          <span></span>
        </div>
